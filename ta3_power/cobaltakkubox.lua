...
local function formspec(self, pos, nvm)
	...
	return techage.storage_formspec(self, pos, nvm, S("TA3 Cobalt Accu Box"), data, nvm.capa, PWR_CAPA)
end
...
local State = techage.NodeStates:new({
	node_name_passive = "techage:ta3_cobaltakku",
...
local function set_capa(pos, oldnode, oldmetadata, drops)
	...
	local text = S("TA3 Cobalt Accu Box").." ("..capa.." %)"
...
local function after_place_node(pos, placer, itemstack)
	local meta = M(pos)
	local nvm = techage.get_nvm(pos)
	local own_num = techage.add_node(pos, "techage:ta3_cobaltakku")
	meta:set_string("owner", placer:get_player_name())
	meta:set_string("infotext", S("TA3 Cobalt Accu Box").." "..own_num)
...
minetest.register_node("techage:ta3_cobaltakku", {
	description = S("TA3 Cobalt Accu Box"),
	tiles = {
...
power.register_nodes({"techage:ta3_cobaltakku"}, Cable, "sto", {"R"})

-- for logical communication
techage.register_node({"techage:ta3_cobaltakku"}, {
...
control.register_nodes({"techage:ta3_cobaltakku"}, {
...
minetest.register_craft({
	output = "techage:ta3_cobaltakku",
	recipe = {
		{"default:tin_ingot", "default:tin_ingot", "techage:cobalt"},
		{"default:copper_ingot", "basic_materials:gear_steel", "techage:electric_cableS"},
		{"techage:iron_ingot", "techage:iron_ingot", "techage:cobalt"},
	},
})